...
public extension String {
     ...
     */
    func localizedFormat(arguments: CVarArg..., using tableName: String? = nil, in bundle: Bundle? = nil) -> String {
     ...
     */
    func localizedPlural(argument: CVarArg, using tableName: String? = nil, in bundle: Bundle? = nil) -> String {
